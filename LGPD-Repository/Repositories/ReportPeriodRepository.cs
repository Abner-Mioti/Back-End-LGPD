...
{
    public class ReportPeriodRepository : RepositoryLGPD<ReportPeriod>, IReportPeriodRepository
    {
        public ReportPeriodRepository(LgpdDbContext context) : base(context)
        {
